        ...
        public async Task<List<BookingViewModel>> GetAllBookingsAsync()
        {
            try
            {
                var bookings = await _context.Bookings
                    ...
                    .Include(b => b.Concept)
                        .ThenInclude(c => c.ConceptColorJunctions)
                    ...
                    .Select(b => new BookingViewModel
                    {
                        ...
                        ColorName = b.Concept != null && b.Concept.ConceptColorJunctions.Any() ? 
                            string.Join(", ", b.Concept.ConceptColorJunctions.Select(ccj => ccj.Color.Name)) : null,
        ...
        public async Task<BookingDetailViewModel?> GetBookingDetailAsync(int bookingId)
        {
            try
            {
                ...
                return new BookingDetailViewModel
                {
                    ...
                    ColorName = booking.Concept?.ConceptColorJunctions?.Any() == true ? 
                        string.Join(", ", booking.Concept.ConceptColorJunctions.Select(ccj => ccj.Color.Name)) : null,
